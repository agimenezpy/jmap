...
function printMap() {
  var printurl = '/doku.php?id=mapa:imprimir&do=export_html';
  var size = map.getSize();
  var centre = map.getCenter().transform(map.projection,map.displayProjection);
  var zoom = map.getZoom();
  var printparams = '&width='+size.w + '&height='+size.h + '&lon='+centre.lon+'&lat='+centre.lat+'&zoom='+zoom;
  window.open(printurl + printparams);
}